...
public class TenantExceptionHandler {
  ...
  public ResponseEntity<ApiErrorResponse> handleTenantNotFoundBySlug(
      TenantNotFoundBySlugException ex) {
    return ResponseEntity.status(HttpStatus.NOT_FOUND)
  ...
  public ResponseEntity<ApiErrorResponse> handleValidation(MethodArgumentNotValidException ex) {
    ...
    return ResponseEntity.badRequest().body(ApiErrorResponse.validation(message, violations));
  }
}
