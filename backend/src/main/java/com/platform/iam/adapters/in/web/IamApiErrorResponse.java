...
public record IamApiErrorResponse(String code, String message, List<FieldViolation> fieldViolations) {
    ...
    public static IamApiErrorResponse validation(String message, List<FieldViolation> fieldViolations) {
