 ...
 *
 * <p>Claims {@code email}, {@code tenantId} e {@code roles} vêm do JWT; ausência ou formato inválido
 * de {@code sub} ou {@code tenantId} → {@link InvalidAuthenticatedTokenException} (401 na borda).
 */
