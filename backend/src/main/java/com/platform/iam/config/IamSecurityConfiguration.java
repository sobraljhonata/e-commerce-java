...
/**
 * Configuração explícita na borda: login público; APIs administrativas com Bearer JWT emitido pelo
 * BC IAM (HS256, mesma chave que {@link
 * com.platform.iam.adapters.out.security.JwtAccessTokenIssuer}).
 */
@Configuration
@EnableWebSecurity
public class IamSecurityConfiguration {
  ...
  @Bean
  SecurityFilterChain iamSecurityFilterChain(HttpSecurity http, JwtDecoder jwtDecoder)
      throws Exception {
