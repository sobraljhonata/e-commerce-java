...
public record CatalogApiErrorResponse(String code, String message, List<FieldViolation> fieldViolations) {
    ...
    public static CatalogApiErrorResponse validation(String message, List<FieldViolation> fieldViolations) {
