...
/**
 * Nenhum produto acessível para o tenant atual com o identificador informado (inexistente ou de outro
 * tenant — tratados igualmente para não vazar existência entre tenants).
 */
