...
class ListProductsApiIntegrationTest {
    ...
    void list_returns_products_for_token_tenant() throws Exception {
        ...
        mockMvc
                ...
                .andExpect(jsonPath("$[0].tenantId").value(InMemoryAdminUserRepository.SEED_TENANT_ID.toString()))
                .andExpect(jsonPath("$[1].tenantId").value(InMemoryAdminUserRepository.SEED_TENANT_ID.toString()));
    }
}
