...
class TenantControllerWebTest {
  ...
  @Mock private GetTenantByIdUseCase getTenantByIdUseCase;

  @Mock private GetTenantBySlugUseCase getTenantBySlugUseCase;

  @Mock private UpdateTenantStatusUseCase updateTenantStatusUseCase;
  ...
  void post_returns_201_when_create_succeeds() throws Exception {
    ...
    var created = new Tenant(id, "acme", "Acme Corp", true);
    ...
    mockMvc
        .perform(
            post("/api/admin/tenants")
                ...
                .content(
                    objectMapper.writeValueAsString(new CreateTenantRequest("acme", "Acme Corp"))))
